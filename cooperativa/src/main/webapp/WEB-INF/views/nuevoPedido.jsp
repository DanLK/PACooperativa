...
<html>
    <head>
        ...
        <script defer src="resources/js/nuevoPedido.js"></script>
    ...
    <div class="pedidoContent">
    	<div class="box">
    		<div><label class="title is-3">Nuevo Pedido</label></div>
    		<div>
    			<div class="listaPd">
    		...
    		<button class="button is-link" id="realizarPedidoBtn">Realizar Pedido</button>
    		</div>
    	</div>
    	<div class="box">
    	...
    	<form:form method="POST" action="registrarPedido" modelAttribute="pedidoCodificado" class="ghostForm" id="registrarPedidoForm">
			<table>
				<tr>
