...
//Clase controlador para las operaciones sobre TODOS los pedidos pagados
@Controller
public class PedidosPagadosController {
	...
	// Definimos el metodo con las operaciones a realizar con /pedidospagados,
	//   que es mostrar todos los pedidos pagados
	...
	public ModelAndView pedidosPagados(
			...
			// Solicitamos a la base de datos TODOS los pedidos pagados
	...
	// Definimos el metodo con las operaciones a realizar con /modificar/allpedidos/{pedidoId},
	...
	public ModelAndView modificarPedido(
			...
			mav.addObject("rutaAction", "../../modificarpedidopagado");
	...
	// Definimos el metodo con las operaciones a realizar con /modificarallpedidos,
