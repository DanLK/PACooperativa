...
CREATE TABLE `pedido` (
  ...
  `pedido_status_pedido_status_id` int(11) NOT NULL,
  `usuario_usuario_id` int(11) NOT NULL,
  PRIMARY KEY (`pedido_id`),
  UNIQUE KEY `idPedido_UNIQUE` (`pedido_id`),
  KEY `fk_pedido_pedidoStatus_idx` (`pedido_status_pedido_status_id`),
  KEY `fk_pedido_usuario1_idx` (`usuario_usuario_id`),
  CONSTRAINT `fk_pedido_pedidoStatus` FOREIGN KEY (`pedido_status_pedido_status_id`) REFERENCES `pedido_status` (`pedido_status_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_pedido_usuario1` FOREIGN KEY (`usuario_usuario_id`) REFERENCES `usuario` (`usuario_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `pedido` VALUES (1,'2019-11-04',15.57,1,6),(2,'2019-11-07',235.89,2,7),(3,'2019-11-07',888.888,1,6),(10,'2019-11-19',888.888,1,8),(11,'2019-11-19',888.888,1,8),(17,'2019-11-26',140,3,7),(18,'2019-11-26',438,1,7),(21,'2019-12-02',516,2,7),(22,'2019-12-02',140,1,7),(23,'2019-12-04',1323,1,7),(24,'2019-12-04',1176,1,7);
...
INSERT INTO `pedido_status` VALUES (1,'Enviado (en espera de pago)'),(2,'Pagado'),(3,'Entregado'),(4,'DESCRIPCION NO MODIFICADA');
...
CREATE TABLE `producto_pedido` (
  `producto_pedido_id` int(11) NOT NULL AUTO_INCREMENT,
  `cantidad` int(11) NOT NULL,
  `pedido_pedido_id` int(11) NOT NULL,
  `producto_producto_id` int(11) NOT NULL,
  PRIMARY KEY (`producto_pedido_id`),
  UNIQUE KEY `productoPedido_id_UNIQUE` (`producto_pedido_id`),
  KEY `fk_productoPedido_pedido1_idx` (`pedido_pedido_id`),
  KEY `fk_productoPedido_producto1_idx` (`producto_producto_id`),
  CONSTRAINT `fk_productoPedido_pedido1` FOREIGN KEY (`pedido_pedido_id`) REFERENCES `pedido` (`pedido_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_productoPedido_producto1` FOREIGN KEY (`producto_producto_id`) REFERENCES `producto` (`producto_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `producto_pedido` VALUES (1,2,2,9),(2,3,2,10),(3,888,3,12),(25,5,18,23),(26,2,18,29),(38,1,17,7),(42,1,21,14),(43,4,21,17),(44,7,21,25),(57,1,22,7),(59,9,23,7),(61,8,24,7);
...
INSERT INTO `rol` VALUES (1,'Administrador'),(2,'Socio'),(3,'DESCRIPCION NO MODIFICADA');
...
CREATE TABLE `usuario` (
  ...
  CONSTRAINT `fk_usuario_rol1` FOREIGN KEY (`rol_rol_id`) REFERENCES `rol` (`rol_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2019-12-04 18:35:45
