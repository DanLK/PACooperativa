...
CREATE TABLE `pedido` (
  ...
  CONSTRAINT `fk_pedido_pedidoStatus` FOREIGN KEY (`pedido_status_pedido_status_id`) REFERENCES `pedido_status` (`pedido_status_id`),
...
INSERT INTO `pedido` VALUES (1,'2019-11-04',15.57,1,6),(2,'2019-11-07',235.89,2,7),(3,'2019-11-07',888.888,1,6),(10,'2019-11-19',888.888,1,8),(11,'2019-11-19',888.888,1,8);
...
INSERT INTO `producto_pedido` VALUES (1,2,2,9),(2,3,2,10),(3,888,3,12);
...
-- Dump completed on 2019-11-18 20:54:43
